...
public class Date32ArrayBuilder : ArrayBuilder
{
	...
	public this()
	{
		auto p = garrow_date32_array_builder_new();
		...
		this(cast(GArrowDate32ArrayBuilder*) p, true);
	}
	...
	public bool append(int value)
	{
		...
		auto p = garrow_date32_array_builder_append(gArrowDate32ArrayBuilder, value, &err) != 0;
	...
	public bool appendNull()
	{
		...
		auto p = garrow_date32_array_builder_append_null(gArrowDate32ArrayBuilder, &err) != 0;
	...
	public bool appendNulls(long n)
	{
		...
		auto p = garrow_date32_array_builder_append_nulls(gArrowDate32ArrayBuilder, n, &err) != 0;
	...
	public bool appendValue(int value)
	{
		...
		auto p = garrow_date32_array_builder_append_value(gArrowDate32ArrayBuilder, value, &err) != 0;
	...
	public bool appendValues(int[] values, bool[] isValids)
	{
		...
		auto p = garrow_date32_array_builder_append_values(gArrowDate32ArrayBuilder, values.ptr, cast(long)values.length, isValidsArray.ptr, cast(long)isValids.length, &err) != 0;
