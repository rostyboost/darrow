...
public class Date64ArrayBuilder : ArrayBuilder
{
	...
	public this()
	{
		auto p = garrow_date64_array_builder_new();
		...
		this(cast(GArrowDate64ArrayBuilder*) p, true);
	}
	...
	public bool append(long value)
	{
		...
		auto p = garrow_date64_array_builder_append(gArrowDate64ArrayBuilder, value, &err) != 0;
	...
	public bool appendNull()
	{
		...
		auto p = garrow_date64_array_builder_append_null(gArrowDate64ArrayBuilder, &err) != 0;
	...
	public bool appendNulls(long n)
	{
		...
		auto p = garrow_date64_array_builder_append_nulls(gArrowDate64ArrayBuilder, n, &err) != 0;
	...
	public bool appendValue(long value)
	{
		...
		auto p = garrow_date64_array_builder_append_value(gArrowDate64ArrayBuilder, value, &err) != 0;
	...
	public bool appendValues(long[] values, bool[] isValids)
	{
		...
		auto p = garrow_date64_array_builder_append_values(gArrowDate64ArrayBuilder, values.ptr, cast(long)values.length, isValidsArray.ptr, cast(long)isValids.length, &err) != 0;
