...
public class Int16ArrayBuilder : ArrayBuilder
{
	...
	public this()
	{
		auto p = garrow_int16_array_builder_new();
		...
		this(cast(GArrowInt16ArrayBuilder*) p, true);
	}
	...
	public bool append(short value)
	{
		...
		auto p = garrow_int16_array_builder_append(gArrowInt16ArrayBuilder, value, &err) != 0;
	...
	public bool appendNull()
	{
		...
		auto p = garrow_int16_array_builder_append_null(gArrowInt16ArrayBuilder, &err) != 0;
	...
	public bool appendNulls(long n)
	{
		...
		auto p = garrow_int16_array_builder_append_nulls(gArrowInt16ArrayBuilder, n, &err) != 0;
	...
	public bool appendValue(short value)
	{
		...
		auto p = garrow_int16_array_builder_append_value(gArrowInt16ArrayBuilder, value, &err) != 0;
	...
	public bool appendValues(short[] values, bool[] isValids)
	{
		...
		auto p = garrow_int16_array_builder_append_values(gArrowInt16ArrayBuilder, values.ptr, cast(long)values.length, isValidsArray.ptr, cast(long)isValids.length, &err) != 0;
