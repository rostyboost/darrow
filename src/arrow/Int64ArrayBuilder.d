...
public class Int64ArrayBuilder : ArrayBuilder
{
	...
	public this()
	{
		auto p = garrow_int64_array_builder_new();
		...
		this(cast(GArrowInt64ArrayBuilder*) p, true);
	}
	...
	public bool append(long value)
	{
		...
		auto p = garrow_int64_array_builder_append(gArrowInt64ArrayBuilder, value, &err) != 0;
	...
	public bool appendNull()
	{
		...
		auto p = garrow_int64_array_builder_append_null(gArrowInt64ArrayBuilder, &err) != 0;
	...
	public bool appendNulls(long n)
	{
		...
		auto p = garrow_int64_array_builder_append_nulls(gArrowInt64ArrayBuilder, n, &err) != 0;
	...
	public bool appendValue(long value)
	{
		...
		auto p = garrow_int64_array_builder_append_value(gArrowInt64ArrayBuilder, value, &err) != 0;
	...
	public bool appendValues(long[] values, bool[] isValids)
	{
		...
		auto p = garrow_int64_array_builder_append_values(gArrowInt64ArrayBuilder, values.ptr, cast(long)values.length, isValidsArray.ptr, cast(long)isValids.length, &err) != 0;
