...
public class Time64ArrayBuilder : ArrayBuilder
{
	...
	{
		auto p = garrow_time64_array_builder_new((dataType is null) ? null : dataType.getTime64DataTypeStruct());
		...
		this(cast(GArrowTime64ArrayBuilder*) p, true);
	}
	...
	public bool append(long value)
	{
		...
		auto p = garrow_time64_array_builder_append(gArrowTime64ArrayBuilder, value, &err) != 0;
	...
	public bool appendNull()
	{
		...
		auto p = garrow_time64_array_builder_append_null(gArrowTime64ArrayBuilder, &err) != 0;
	...
	public bool appendNulls(long n)
	{
		...
		auto p = garrow_time64_array_builder_append_nulls(gArrowTime64ArrayBuilder, n, &err) != 0;
	...
	public bool appendValue(long value)
	{
		...
		auto p = garrow_time64_array_builder_append_value(gArrowTime64ArrayBuilder, value, &err) != 0;
	...
	public bool appendValues(long[] values, bool[] isValids)
	{
		...
		auto p = garrow_time64_array_builder_append_values(gArrowTime64ArrayBuilder, values.ptr, cast(long)values.length, isValidsArray.ptr, cast(long)isValids.length, &err) != 0;
